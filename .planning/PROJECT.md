...
## Current Milestone: v1.4 중복 계산기 정리 및 코드 클린업

**Goal:** 기능이 겹치는 계산기를 찾아 통합/삭제하고, 이미 삭제된 파일을 정리하여 코드베이스를 깔끔하게 만든다.

**Target features:**
- 이미 통합 완료된 삭제 파일 13개 커밋 정리
- 현재 47개 계산기 중 기능 중복 분석 후 추가 통합/삭제
- tools-data.ts 정리 및 라우트 정합성 확인
...
- [ ] 이미 통합된 삭제 파일 커밋 정리
- [ ] 47개 계산기 기능 중복 분석 및 추가 통합/삭제
- [ ] tools-data.ts 라우트 정합성 확인
