...
- [x] **DAMAGES-03**: 의료사고 손해배상 계산기 (medical-malpractice) — 의료법·판례 기준 검증 및 오류 수정
- [x] **DAMAGES-04**: 일실수입 계산기 (lost-income) — 일실수입 산정 판례 기준 검증 및 오류 수정
