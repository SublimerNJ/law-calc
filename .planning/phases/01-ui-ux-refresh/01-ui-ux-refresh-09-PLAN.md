...
wave: 1
depends_on: []
files_modified: ["src/app/tools/family/property-division/page.tsx", "src/app/tools/family/inheritance-order/page.tsx", "src/app/tools/family/forced-heirship/page.tsx"]
autonomous: true
requirements: [UX-01]
...
<tasks>
<task type="auto">
  <name>Task 1: Update property-division/page.tsx</name>
...
- Add cursor-pointer and hover transitions (150-300ms) on all interactive elements.
  ...
  <verify>
    <automated>grep -q "Fira Code\|grid\|#3B82F6" "src/app/tools/family/property-division/page.tsx" || echo "Verification warning"</automated>
  </verify>
  <done>Page reflects data-dense dashboard style and passes contrast checks</done>
</task>
<task type="auto">
  <name>Task 2: Update inheritance-order/page.tsx</name>
...
- Add cursor-pointer and hover transitions (150-300ms) on all interactive elements.
  ...
  <verify>
    <automated>grep -q "Fira Code\|grid\|#3B82F6" "src/app/tools/family/inheritance-order/page.tsx" || echo "Verification warning"</automated>
  </verify>
  <done>Page reflects data-dense dashboard style and passes contrast checks</done>
</task>
<task type="auto">
  <name>Task 3: Update forced-heirship/page.tsx</name>
...
- Add cursor-pointer and hover transitions (150-300ms) on all interactive elements.
  ...
  <verify>
    <automated>grep -q "Fira Code\|grid\|#3B82F6" "src/app/tools/family/forced-heirship/page.tsx" || echo "Verification warning"</automated>
  </verify>
  <done>Page reflects data-dense dashboard style and passes contrast checks</done>
</task>
...
<output>
After completion, create `.planning/phases/01-ui-ux-refresh/01-ui-ux-refresh-09-SUMMARY.md`
</output>
