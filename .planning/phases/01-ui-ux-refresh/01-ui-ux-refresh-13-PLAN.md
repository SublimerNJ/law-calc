...
wave: 1
depends_on: []
files_modified: ["src/app/tools/tax/securities-tax/page.tsx", "src/app/tools/tax/acquisition-tax/page.tsx", "src/app/tools/tax/comprehensive-income-tax/page.tsx"]
autonomous: true
requirements: [UX-01]
...
<tasks>
<task type="auto">
  <name>Task 1: Update securities-tax/page.tsx</name>
...
- Add cursor-pointer and hover transitions (150-300ms) on all interactive elements.
  ...
  <verify>
    <automated>grep -q "Fira Code\|grid\|#3B82F6" "src/app/tools/tax/securities-tax/page.tsx" || echo "Verification warning"</automated>
  </verify>
  <done>Page reflects data-dense dashboard style and passes contrast checks</done>
</task>
<task type="auto">
  <name>Task 2: Update acquisition-tax/page.tsx</name>
...
- Add cursor-pointer and hover transitions (150-300ms) on all interactive elements.
  ...
  <verify>
    <automated>grep -q "Fira Code\|grid\|#3B82F6" "src/app/tools/tax/acquisition-tax/page.tsx" || echo "Verification warning"</automated>
  </verify>
  <done>Page reflects data-dense dashboard style and passes contrast checks</done>
</task>
<task type="auto">
  <name>Task 3: Update comprehensive-income-tax/page.tsx</name>
...
- Add cursor-pointer and hover transitions (150-300ms) on all interactive elements.
  ...
  <verify>
    <automated>grep -q "Fira Code\|grid\|#3B82F6" "src/app/tools/tax/comprehensive-income-tax/page.tsx" || echo "Verification warning"</automated>
  </verify>
  <done>Page reflects data-dense dashboard style and passes contrast checks</done>
</task>
...
<output>
After completion, create `.planning/phases/01-ui-ux-refresh/01-ui-ux-refresh-13-SUMMARY.md`
</output>
