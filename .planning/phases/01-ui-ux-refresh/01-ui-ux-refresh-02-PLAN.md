...
wave: 1
depends_on: []
files_modified: ["src/app/terms/page.tsx", "src/app/editorial-policy/page.tsx", "src/app/tools/[category]/[tool]/page.tsx"]
autonomous: true
requirements: [UX-01]
...
must_haves:
  ...
  artifacts:
    ...
    - path: "src/app/editorial-policy/page.tsx"
      provides: "Data-Dense Dashboard UI"
...
<tasks>
<task type="auto">
  <name>Task 1: Update terms/page.tsx</name>
...
- Add cursor-pointer and hover transitions (150-300ms) on all interactive elements.
  ...
  <verify>
    <automated>grep -q "Fira Code\|grid\|#3B82F6" "src/app/terms/page.tsx" || echo "Verification warning"</automated>
  </verify>
  <done>Page reflects data-dense dashboard style and passes contrast checks</done>
</task>
<task type="auto">
  <name>Task 2: Update editorial-policy/page.tsx</name>
  <files>src/app/editorial-policy/page.tsx</files>
  <action>
Refactor UI to match Data-Dense Dashboard style.
- Use Fira Code / Fira Sans for typography.
- Implement minimal padding, grid layouts, and KPI cards above the fold.
...
- Add cursor-pointer and hover transitions (150-300ms) on all interactive elements.
  ...
  <verify>
    <automated>grep -q "Fira Code\|grid\|#3B82F6" "src/app/editorial-policy/page.tsx" || echo "Verification warning"</automated>
  </verify>
  <done>Page reflects data-dense dashboard style and passes contrast checks</done>
</task>
<task type="auto">
  <name>Task 3: Update [tool]/page.tsx</name>
  <files>src/app/tools/[category]/[tool]/page.tsx</files>
  <action>
Refactor UI to match Data-Dense Dashboard style.
- Use Fira Code / Fira Sans for typography.
- Implement minimal padding, grid layouts, and KPI cards above the fold.
...
- Add cursor-pointer and hover transitions (150-300ms) on all interactive elements.
  ...
  <verify>
    <automated>grep -q "Fira Code\|grid\|#3B82F6" "src/app/tools/[category]/[tool]/page.tsx" || echo "Verification warning"</automated>
  </verify>
  <done>Page reflects data-dense dashboard style and passes contrast checks</done>
</task>
...
<output>
After completion, create `.planning/phases/01-ui-ux-refresh/01-ui-ux-refresh-02-SUMMARY.md`
</output>
