...
wave: 1
depends_on: []
files_modified: ["src/app/tools/realty/deposit-return/page.tsx", "src/app/tools/realty/brokerage-fee/page.tsx", "src/app/tools/realty/rent-conversion/page.tsx"]
autonomous: true
requirements: [UX-01]
...
<tasks>
<task type="auto">
  <name>Task 1: Update deposit-return/page.tsx</name>
...
- Add cursor-pointer and hover transitions (150-300ms) on all interactive elements.
  ...
  <verify>
    <automated>grep -q "Fira Code\|grid\|#3B82F6" "src/app/tools/realty/deposit-return/page.tsx" || echo "Verification warning"</automated>
  </verify>
  <done>Page reflects data-dense dashboard style and passes contrast checks</done>
</task>
<task type="auto">
  <name>Task 2: Update brokerage-fee/page.tsx</name>
...
- Add cursor-pointer and hover transitions (150-300ms) on all interactive elements.
  ...
  <verify>
    <automated>grep -q "Fira Code\|grid\|#3B82F6" "src/app/tools/realty/brokerage-fee/page.tsx" || echo "Verification warning"</automated>
  </verify>
  <done>Page reflects data-dense dashboard style and passes contrast checks</done>
</task>
<task type="auto">
  <name>Task 3: Update rent-conversion/page.tsx</name>
...
- Add cursor-pointer and hover transitions (150-300ms) on all interactive elements.
  ...
  <verify>
    <automated>grep -q "Fira Code\|grid\|#3B82F6" "src/app/tools/realty/rent-conversion/page.tsx" || echo "Verification warning"</automated>
  </verify>
  <done>Page reflects data-dense dashboard style and passes contrast checks</done>
</task>
...
<output>
After completion, create `.planning/phases/01-ui-ux-refresh/01-ui-ux-refresh-08-SUMMARY.md`
</output>
