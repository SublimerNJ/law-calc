...
wave: 1
depends_on: []
files_modified: ["src/app/tools/tax/capital-gains-tax/page.tsx", "src/app/tools/tax/rent-tax-credit/page.tsx", "src/app/tools/tax/vat/page.tsx"]
autonomous: true
requirements: [UX-01]
...
<tasks>
<task type="auto">
  <name>Task 1: Update capital-gains-tax/page.tsx</name>
...
- Add cursor-pointer and hover transitions (150-300ms) on all interactive elements.
  ...
  <verify>
    <automated>grep -q "Fira Code\|grid\|#3B82F6" "src/app/tools/tax/capital-gains-tax/page.tsx" || echo "Verification warning"</automated>
  </verify>
  <done>Page reflects data-dense dashboard style and passes contrast checks</done>
</task>
<task type="auto">
  <name>Task 2: Update rent-tax-credit/page.tsx</name>
...
- Add cursor-pointer and hover transitions (150-300ms) on all interactive elements.
  ...
  <verify>
    <automated>grep -q "Fira Code\|grid\|#3B82F6" "src/app/tools/tax/rent-tax-credit/page.tsx" || echo "Verification warning"</automated>
  </verify>
  <done>Page reflects data-dense dashboard style and passes contrast checks</done>
</task>
<task type="auto">
  <name>Task 3: Update vat/page.tsx</name>
...
- Add cursor-pointer and hover transitions (150-300ms) on all interactive elements.
  ...
  <verify>
    <automated>grep -q "Fira Code\|grid\|#3B82F6" "src/app/tools/tax/vat/page.tsx" || echo "Verification warning"</automated>
  </verify>
  <done>Page reflects data-dense dashboard style and passes contrast checks</done>
</task>
...
<output>
After completion, create `.planning/phases/01-ui-ux-refresh/01-ui-ux-refresh-12-SUMMARY.md`
</output>
