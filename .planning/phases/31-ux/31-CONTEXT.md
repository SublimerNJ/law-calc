# Phase 31: 교통/형사 + 채권/이자 UX·논리 감사 - Context
...
교통/형사 4개 및 채권/이자 3개, 총 7개 계산기에서 사용자가 정상적으로 사용할 때 논리적으로 이상하다고 느낄 수 있는 모든 포인트를 찾아 수정한다. 16개 요구사항(INPUT, RESULT, FLOW, CONSIST, EDGE)을 각 계산기에 적용.
