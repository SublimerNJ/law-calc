# Phase 29: 세금 Part 2 UX·논리 감사 - Context
...
세금 후반부 5개 계산기(부가세·증권거래세·연말정산·4대보험·월세공제)에서 사용자가 정상적으로 사용할 때 논리적으로 이상하다고 느낄 수 있는 모든 포인트를 찾아 수정한다. 16개 요구사항(INPUT, RESULT, FLOW, CONSIST, EDGE)을 각 계산기에 적용.
