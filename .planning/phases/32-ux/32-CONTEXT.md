# Phase 32: 손해배상 + 기타 법률도구 UX·논리 감사 - Context
...
손해배상 4개 및 기타 법률도구 4개, 총 8개 계산기/도구에서 사용자가 정상적으로 사용할 때 논리적으로 이상하다고 느낄 수 있는 모든 포인트를 찾아 수정한다. 16개 요구사항(INPUT, RESULT, FLOW, CONSIST, EDGE)을 각 계산기에 적용.
