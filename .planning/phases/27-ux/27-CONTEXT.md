# Phase 27: 노동/근로 Part 2 UX·논리 감사 - Context
...
노동/근로 후반부 6개 계산기(부당해고·산재·출산·육아·실업급여·휴업)에서 사용자가 정상적으로 사용할 때 논리적으로 이상하다고 느낄 수 있는 모든 포인트를 찾아 수정한다. 16개 요구사항(INPUT, RESULT, FLOW, CONSIST, EDGE)을 각 계산기에 적용.
