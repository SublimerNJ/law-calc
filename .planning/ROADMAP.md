...
- [x] 18-02-PLAN.md — fine-penalty, bail 법률 감사 (TRAFFIC-03, TRAFFIC-04)
...
Plans:
- [x] 19-01-PLAN.md — late-payment, loan-interest, unjust-enrichment 법률 감사 (DEBT-01~03)
...
- [x] 24-03-PLAN.md — attorney-fee 감사 + 5개 계산기 일관성 통일
...
- [x] 29-02-PLAN.md — year-end-tax + four-insurances + rent-tax-credit 감사 및 수정
- [x] 29-03-PLAN.md — 5개 계산기 일관성 통일
...
- [x] 35-03-PLAN.md — weekly-holiday-pay, minimum-wage-check, shutdown-allowance UI 연동
- [x] 35-04-PLAN.md — maternity-leave, parental-leave, unemployment-benefit UI 연동
...
**Plans**: 2 plans
Plans:
- [ ] 39-01-PLAN.md — action-data.ts 3개 채권/이자 도구 데이터 추가
- [ ] 39-02-PLAN.md — late-payment, loan-interest, unjust-enrichment UI 연동
...
| 39. 채권/이자 ActionInsight 연동 | v1.8 | 0/2 | Pending | — |
