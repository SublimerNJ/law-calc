      ...
      <div className="space-y-12 text-slate-700 text-[15px] leading-relaxed">
        ...
        <section>
          ...
          <ul className="list-disc list-inside space-y-2 text-slate-600 bg-slate-50 p-6 rounded-xl border border-slate-100 glassmorphism glass-panel">
            ...
            <li>사용자는 <a aria-label="Link" href="https://myadcenter.google.com/" target="_blank" rel="noopener noreferrer" className="text-teal-800 hover:underline font-medium cursor-pointer focus:outline-none focus:ring-2 focus:ring-brand-primary focus:ring-offset-2 min-h-[44px] min-w-[44px]">Google 광고 설정 (My Ad Center)</a>을 방문하여 맞춤 광고에 사용되는 DART 쿠키의 사용을 선택 해제(Opt-out)할 수 있습니다.</li>
            <li>또는 <a aria-label="Link" href="https://www.aboutads.info/" target="_blank" rel="noopener noreferrer" className="text-teal-800 hover:underline font-medium cursor-pointer focus:outline-none focus:ring-2 focus:ring-brand-primary focus:ring-offset-2 min-h-[44px] min-w-[44px]">aboutads.info</a> 페이지를 방문하여 제3자 공급업체의 맞춤 광고 쿠키 사용을 해제할 수 있습니다.</li>
          </ul>
        </section>
        ...
        <section>
          ...
          <div className="mt-4 p-4 bg-teal-800 text-white rounded-lg glassmorphism glass-panel">
