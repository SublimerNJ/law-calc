  ...
  return (
    <CalculatorLayout tool={tool} category={category}>
      <div className="flex rounded-lg overflow-hidden mb-4 border border-slate-200">
        ...
        <div className="flex-1 py-3 text-center text-sm font-semibold bg-teal-800 text-white">법률구조공단</div>
      </div>
      ...
      {result && (
        <div className="premium-card p-6">
          ...
          {result.eligible && (
            <div className="p-3 rounded-lg bg-teal-50 border border-blue-200">
