    ...
    <CalculatorLayout tool={tool} category={category}>
      <div className="premium-card p-6 mb-4">
        <div className="space-y-4">
          <div>
            <label className="block text-sm text-gray-400 mb-1">사건 유형</label>
            <select
              value={caseType}
          ...
          <div>
            <label className="block text-sm text-gray-400 mb-1">월 평균 소득 (원)</label>
            <input
              type="text"
              value={monthlyIncome}
      ...
      {result && (
        <div className="premium-card p-6">
          ...
          <div className={`p-4 rounded-lg mb-4 ${result.eligible ? 'bg-green-900/30 border border-green-700' : 'bg-red-900/30 border border-red-700'}`}>
            ...
            <p className="text-sm text-gray-400 mt-1">{result.type}</p>
          </div>
