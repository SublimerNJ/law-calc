    ...
    <main className="max-w-3xl mx-auto px-4 py-24 sm:py-32">
      ...
      <article className="prose prose-slate prose-lg max-w-none">
        ...
        <div className="bg-amber-50 border border-amber-100 p-6 rounded-xl my-8">
          ...
          <Link href="/tools/labor/severance-pay" className="inline-block bg-amber-500 text-white px-5 py-2.5 rounded-lg text-sm font-medium hover:bg-amber-600 transition-colors">
            퇴직금 계산기 가기
          </Link>
        </div>
