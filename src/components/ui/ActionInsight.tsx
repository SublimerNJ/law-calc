...
export function ActionInsight({ calculatorId, amount }: ActionInsightProps) {
  ...
  return (
    <div className="mt-8 mb-6 bg-blue-50 border border-blue-200 rounded-lg p-5 md:p-6 shadow-sm">
      ...
      {data.scriptTemplate && (
        <div className="mt-6 bg-white border border-blue-200 rounded-md p-4">
          ...
          <div className="text-right">
            <button
              ...
              className="inline-flex items-center justify-center px-4 py-2 text-sm font-medium transition-colors bg-white border border-slate-300 text-slate-700 rounded-md hover:bg-slate-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500"
            >
